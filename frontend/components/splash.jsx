 ...
 const Splash = () => (
  <div>
    ...
    <section className="section white">
      ...
      <figure>screenshot or gif of clock</figure>
      <h2>Realtime data</h2>
    ...
    <section className="section green">
      ...
      <p>This project was created to try to build a site similar to Robinhood's. The trading feature was dropped in favor of easier-to-see charting and news aggregation features.</p>
